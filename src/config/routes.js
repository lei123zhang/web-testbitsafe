...
import legalRecharge from '../components/uc/legalRecharge'
import legalWithdraw from '../components/uc/legalWithdraw'
...
import newCurrencyVote from '../pages/uc/NewCurrencyVote'
export default [
    ...
    {
        path: '/newCurrencyVote',
        component: newCurrencyVote
    },
    {
        path: '/newhelp',
        component: newhelp,
