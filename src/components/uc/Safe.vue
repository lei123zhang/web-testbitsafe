                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <a class="btn" @click="showItem(6)" v-else-if="user.realVerified==0&&user.realAuditing==0&&user.realNameRejectReason!=null" :title="user.realNameRejectReason">{{$t('uc.binderr')}}</a>
                                <a v-else class="btn" @click="showItem(6)">{{$t('uc.bind')}}</a>
                                <p>{{user.realNameRejectReason}}</p>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <!-- <img src="../../assets/images/warn.jpg" alt=""> -->
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <a class="btn" v-else @click="showItemFundpwd()">{{$t('common.modify')}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==5">
                                ...
                                <!-- 找回 -->
                                <div class="detail-list" v-show="user.fundsVerified==1 && fGetBackFundpwd">
                                  <Form ref="formValidate8" :model="formValidate8" :rules="ruleValidate" :label-width="90">
                                    <!-- newMPw -->
                                    <FormItem :label="$t('common.newPriceW')" prop="newMPw8">
                                      <Input v-model="formValidate8.newMPw8" size="large" type="password"></Input>
                                    </FormItem>
                                    <!-- newMPwConfirm -->
                                    <FormItem :label="$t('common.newPwConfirm')" prop="newMPwConfirm8">
                                    ...
                                    <!-- Button -->
                                    <FormItem>
                                      <Button type="primary" @click="handleSubmit('formValidate8')">{{$t('common.save')}}</Button>
                                      <Button type="ghost" @click="handleReset('formValidate8')" style="margin-left: 8px">{{$t('common.reset')}}</Button>
                                    </FormItem>
                                  </Form>
                                </div>
                            </div>
...
export default {
    ...
    data() {
        const validatePass = (rule, value, callback) => {
            ...
            } else if (!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[\s\S]{6,20}$/.test(value)) {
                callback(new Error(this.$t('uc.newLoginPwRule')));
            } else {
                callback();
            }
        ...
        return {
            ...
            ruleValidate: {
                ...
                newMPw8: [
                  { required: true, type: 'string', min: 6, message: this.$t('uc.oldPriceWRule'), trigger: 'blur' },
    ...
    methods: {
        ...
        handleSubmit(name) {
			// let reg = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[\s\S]{6,20}$/g;
			// if(!reg.test(this.formValidate4.newPw)) {
