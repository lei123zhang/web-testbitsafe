            ...
            <div class="bill_box rightarea padding-right-clear record">
                <div class="col-xs-12 rightarea-con">
                    <div class="form-group">
                        ...
                        <Button type="error" @click="queryOrder" style="padding: 6px 50px;margin-left:10px;">{{$t('finance.search')}}</Button>
                    </div>
    ...
    methods: {
        ...
        //   }else {
          ...
          //}
            ...
            if (this.rangeDate.length == 0) {
                this.$Message.error( self.$t('finance.searchTime'));
                return;
            }else {
                try {
                rangedate += this.rangeDate[0].getFullYear() + "-" + (this.rangeDate[0].getMonth() + 1) + "-" + this.rangeDate[0].getDate();
