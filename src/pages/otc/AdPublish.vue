                        ...
                        <div class="send-box">
                            ...
                            <div class="formbox send-form">
                                <Form ref="form" :model="form" :rules="ruleValidate" :label-width="90">
                                    ...
                                    <FormItem :label="$t('otc.autoReply')" prop="autodesc" v-show="form.autoReply">
                                        <Input v-model="form.autodesc" type="textarea" :autosize="{minRows: 4,maxRows: 6}" :placeholder="$t('otc.autoReplyTip')"></Input>
                                    </FormItem>
