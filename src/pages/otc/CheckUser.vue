                            ...
                            <Tabs value="name1">
                                <TabPane :label="$t('otc.onlineSale')" name="name1">
                                    <div class="order-table">
                                        <Table stripe :columns="tableColumnsOrderSell" :data="tableOrderSell" :loading="loading" :no-data-text="$t('common.nodata')"></Table>
                                ...
                                <TabPane :label="$t('otc.onlinePurchase')" name="name2">
                                    <div class="order-table">
                                        <Table stripe :columns="tableColumnsOrderBuy" :data="tableOrderBuy" :loading="loading" :no-data-text="$t('common.nodata')"></Table>
                                        <!-- <div style="margin: 10px;overflow: hidden">
                                                                                    <div style="float: right;">
                                                                                        <Page :total="100" :current="1" @on-change="changePage"></Page>
                                                                                    </div>
                            ...
                            on: {
                                click: function() {
                                    if (!self.isLogin) {
                                        ...
                                        self.$router.push('/tradeInfo?tradeId=' + params.row.advertiseId);
                                    }
                                }
                            },
                            style: {
