            ...
            <Tabs :value="tabPage">
                <TabPane :label="$t('common.ibuy')" name="buy">
                    ...
                    <div class="table-responsive list-table">
                        <Table :border="showBorder" :stripe="showStripe" :show-header="showHeader" :height="fixedHeader ? 250 : ''" :size="tableSize" :data="advertiment.ask.rows" :columns="advertiment.columns" :loading="loading" :no-data-text="$t('common.nodata')"></Table>
                ...
                <TabPane :label="$t('common.isell')" name="sell">
                   <div class="table-responsive list-table">
                        <Table :border="showBorder" :stripe="showStripe" :show-header="showHeader" :height="fixedHeader ? 250 : ''" :size="tableSize" :data="advertiment.bid.rows" :columns="advertiment.columns" :loading="loading" :no-data-text="$t('common.nodata')"></Table>
                        <div style="margin: 10px;overflow: hidden">
                            <div style="float: right;">
